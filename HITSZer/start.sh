...
player_conf="${DIR}/src/player.conf"
config_dir="${DIR}/src/formations-dt"

coach_conf="${DIR}/src/coach.conf"
team_graphic="--use_team_graphic on --team_graphic_file=${DIR}/src/team_logo.xpm"
