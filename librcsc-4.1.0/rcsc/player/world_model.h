...
public:
    ...
    */
    ...
    //mark system
    const std::vector <std::pair <int, int> > & getMarkPairs() const
    { 
		return M_mark_pairs; 
	}
	
     
    const int getMarkUnum() const 
    {
		return M_mark_unum;
	}
...
private:
    ...
    */
    ...
    void updateMarkPairs(WorldModel* wm);   //只有守门员会调用
...
public:
    ...
    */
    ...
    void findMax( std::vector <std::vector <double> > & vec, int i, int length, std::vector <int> & maxLoc, int option, WorldModel* wm );
