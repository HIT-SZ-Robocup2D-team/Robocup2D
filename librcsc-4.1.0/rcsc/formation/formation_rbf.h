...
/*!
  \file formation_rbf.h
  \brief formation data classes using RBF network Header File.
*/
...
#ifndef RCSC_FORMATION_FORMATION_RBF_H
#define RCSC_FORMATION_FORMATION_RBF_H
...
public:
    ...
    */
    ...
    private:
        ...
        RBFNetwork M_net; //!< RBFnetwork instance
    ...
    public:
        ...
        */
        ...
        /*!
          ...
          \param type side type, if this is symmetry, the refered param is used.
...
public:
    ...
    */
    ...
    Formation::Ptr create()
      {
          return Formation::Ptr( new FormationRBF() );
      }
